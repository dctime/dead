...
DEAD_CollisionDirector::entityCheckCollision(
    double targetX, double targetY, const std::shared_ptr<DEAD_Entity>& entity) {
...
std::set<std::shared_ptr<DEAD_MapObjectBase>>
DEAD_CollisionDirector::entityCheckCollision(
    const std::shared_ptr<DEAD_Entity>& entity, DEAD_Map::MapLocation targetLoc) {
  return entityCheckCollision(targetLoc.x, targetLoc.y, entity);
}

std::set<std::shared_ptr<DEAD_MapObjectBase>>
DEAD_CollisionDirector::entityCheckCollision(
    const std::shared_ptr<DEAD_Entity>& player, double moveXDelta, double moveYDelta) {
