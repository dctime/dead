...
const std::string DEAD_FilePaths::BULLET_TEXTURE_PNG = ASSETS_FILE_PATH + "/imgs/bullets.png";
...
const std::string DEAD_FilePaths::ZOMBIES_3D_TEXTURE_PNG = ASSETS_FILE_PATH + "/imgs/zombies3d.png";
