...
int main(int argc, char **argv) {
  ...
  //
  // dead::window =
  //     GTK_WIDGET(gtk_builder_get_object(dead::builder, "mainWindow"));
  // dead::playButton =
  //     GTK_BUTTON(gtk_builder_get_object(dead::builder, "playButton"));
  // dead::enterYourNameEntry =
  //     GTK_ENTRY(gtk_builder_get_object(dead::builder, "enterYourNameEntry"));
  //
  // g_signal_connect(dead::window, "destroy",
  //                  G_CALLBACK(dead::onMainWindowDestory), NULL);
  // g_signal_connect(dead::playButton, "clicked",
  //                  G_CALLBACK(dead::onPlayButtonClicked), NULL);
  //
  ...
  // gtk_tree_view_column_add_attribute(dead::columnLongestName,
  //                                    dead::cellRendererLongestName, "text", 0);
  // gtk_tree_view_column_add_attribute(dead::columnLongestTime,
  //                                    dead::cellRendererLongestTime, "text", 1);
  //
  ...
  //   dead::conn = dead::driver->connect("sql12.freemysqlhosting.net",
  ...
  //     gtk_list_store_set(dead::liststoreLongest, &iterLongest, 0, nameChars,
  //                        -1);
  //     gtk_list_store_set(dead::liststoreLongest, &iterLongest, 1,
  //                        timeFormattedChars, -1);
...
// }
//
// void dead::playButtonPressed() { dead::pressedPlay = true; }
//
...
// }
//
// bool dead::closeDBConnection() {
//   try {
//     dead::conn->close();
//     delete dead::conn;
//     dead::driver->threadEnd();
//     return true;
//   } catch (sql::SQLException &e) {
//     std::cout << "Failed To Close Connection to DataBase Server" << e.what()
//               << std::endl;
//     return false;
//   }
// }
